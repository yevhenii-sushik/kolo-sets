  ...
  const versions = [
    {
      ...
      changes: [
        "Добавелна поддержка синхронизации данных через облако (Cloud Sync)",
        ...
        "Добавлена функкция синтеза речи (Text-to-Speech) для карточек",
        "Добавлено звуковое сопровождение для разных сценариев действий (правильный ответ, неправильный ответ, достижение новых уровней и т.д.)",
        "Добавлена система достижений и уровней для мотивации пользователей",
        "Добавлена система страйков (Огоньков 🔥)",
        "Добавлена поддержка нескольких языков интерфейса (локализация)",
        "Изменены окна оповещений и уведомлений для более приятного пользовательского опыта",
        "Реализована более детальная статистика и аналитика прогресса пользователя",
      ]
    },
    {
      number: "0.1.2",
