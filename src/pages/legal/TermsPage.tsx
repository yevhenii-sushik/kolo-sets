    ...
    <div>
      ...
      <div className="mb-10 p-6 rounded-3xl bg-white dark:bg-[#1A1917] border border-[#E0DBD3] dark:border-[#2E2C29]">
        <p className="text-[14px] text-[#5A5650] dark:text-[#9A9590] leading-relaxed font-medium">
          ...
          Kolo Sets web application ("Service") provided by{" "}
          <strong className="text-[#1A1714] dark:text-[#F0EDE8]">
            Dakuta Software
          </strong>
      ...
      <Section title="1. Description of Service" icon={UserCheck}>
        <P>
          Kolo Sets is a free, browser-based application for learning languages
          — primarily Norwegian — through flashcards with spaced-repetition
          (SM-2 algorithm), quiz modes, daily puzzles, and progress tracking.
        </P>
        <P>
          The Service is provided free of charge. We reserve the right to
          introduce optional premium features in the future with advance notice
          to existing users.
        </P>
      </Section>
      ...
      <Section title="2. Eligibility & Account" icon={UserCheck}>
        ...
        />
        <P>
          One account per person. You may not create accounts for others without
      ...
      <Section title="4. Your Content" icon={Pencil}>
        <P>
          You retain full ownership of the flashcard collections and content you
          create in Kolo Sets.
        </P>
        <UL
          items={[
      ...
      {/* 5. Availability */}
      <Section
        title="5. Service Availability & Disclaimer"
        icon={AlertTriangle}
      >
        <P>
        ...
        />
        <P>
          To the maximum extent permitted by applicable law, Dakuta shall not be
      ...
      <Section title="6. Account Termination" icon={ShieldOff}>
        <P>
          ...
          Management → Delete Account. This permanently deletes all your data.
        </P>
        <P>
          <strong className="text-[#1A1714] dark:text-[#F0EDE8]">By us:</strong>{" "}
          We reserve the right to suspend or terminate accounts that violate
          these Terms, engage in fraudulent activity, or cause harm to the
          Service or other users. We will make reasonable efforts to notify you
          before taking action, unless immediate action is required to protect
          security.
        </P>
      </Section>
      ...
      <Section title="7. Intellectual Property" icon={Scale}>
        <P>
          All content of Kolo Sets itself — including the application code,
          design, logos, branding, and curated word sets ("Kolo Sets"
          collections) — is the property of Dakuta Software and is protected by
          copyright and other applicable laws.
        </P>
        <P>
          You may not copy, reproduce, distribute, or create derivative works of
          the application without explicit written permission from Dakuta
          Software.
        </P>
      </Section>
      ...
      <Section title="8. Changes to These Terms" icon={Repeat}>
        <P>
          ...
          update the effective date and, for material changes, notify users via
          an in-app notification.
        </P>
        <P>
          Your continued use of the Service after the updated Terms take effect
          constitutes your acceptance of the new Terms. If you do not agree to
          the new Terms, you should stop using the Service and delete your
          account.
        </P>
      </Section>
      ...
      <Section title="9. Governing Law" icon={Scale}>
        <P>
          ...
          of{" "}
          <strong className="text-[#1A1714] dark:text-[#F0EDE8]">Norway</strong>
        ...
        <P>
          If you are located in the European Union, you also benefit from any
          mandatory consumer protection provisions of the laws of your country
          of residence.
        </P>
      </Section>
