...
export default function Flashcard({ card, isFlipped, language = 'nb-NO', onFlip }: FlashcardProps) {
  ...
  return (
    <div
      ...
      onClick={onFlip}
    >
      <div className="flip-card-inner relative w-full h-96 cursor-pointer">
        {/* Передняя сторона - Слово */}
        <div className="flip-card-front absolute w-full h-full">
          <div className="w-full h-full bg-gradient-to-br from-blue-500 to-blue-700 dark:from-blue-600 dark:to-blue-900 rounded-2xl shadow-2xl flex items-center justify-center p-8 border-4 border-white dark:border-gray-700">
            <div className="text-center">
              <div className="text-5xl font-bold text-white mb-4 flex items-center justify-center gap-3">
                {card.word}
                {ttsSupported && (
                  <button
                    onClick={handleSpeak}
        ...
        <div className="flip-card-back absolute w-full h-full">
          <div className="w-full h-full bg-gradient-to-br from-green-500 to-green-700 dark:from-green-600 dark:to-green-900 rounded-2xl shadow-2xl p-8 border-4 border-white dark:border-gray-700 overflow-y-auto">
            <div className="text-white">
              {/* Слово сверху для контекста */}
              <div className="text-2xl font-bold mb-6 text-center opacity-80 flex items-center justify-center gap-2">
                {card.word}
                {ttsSupported && (
                  <button
                    onClick={handleSpeak}
